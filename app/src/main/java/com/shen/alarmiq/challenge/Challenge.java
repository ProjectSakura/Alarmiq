 ...
 *
 * <p>For all types, {@link #expected} holds the canonical answer
 * that user input is compared against.</p>
 */
public class Challenge {
    ...
    /** The prompt the user reads. */
    public final String prompt;
    /** For PARAGRAPH/REVERSE the canonical answer. For MATH, the numeric answer. */
